...
<policy>
    <template>
        ...
        <permissions>
            ...
            <permission>
                <name>file_unpack</name>
                <description>perm.file_unpack_desc</description>
                <value>1</value>
            </permission>
            <permission>
                <name>file_view</name>
    ...
    <description>Context administration policy with limited, content-editing related Permissions, but no publishing.</description>
    <class></class>
    <permissions>
        <permission>
            <name>about</name>
